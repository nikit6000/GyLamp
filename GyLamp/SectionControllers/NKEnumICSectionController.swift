...
class NKEnumICSectionController: ListBindingSectionController<ListDiffable>, ListBindingSectionControllerDataSource, ListBindingSectionControllerSelectionDelegate {
    ...
    func sectionController(_ sectionController: ListBindingSectionController<ListDiffable>, viewModelsFor object: Any) -> [ListDiffable] {
        ...
        for i in 0 ..< titles.count {
            ...
            case is NKListRangedModel<Float>:
                models.append(NKListRangedModel(rangedModel: value as! NKListRangedModel<Float>, title: titles[i], icon: icon, description: description))
            case is NKListRangedModel<UInt16>:
                models.append(NKListRangedModel(rangedModel: value as! NKListRangedModel<UInt16>, title: titles[i], icon: icon, description: description))
            case is NKListRangedModel<UInt32>:
                models.append(NKListRangedModel(rangedModel: value as! NKListRangedModel<UInt32>, title: titles[i], icon: icon, description: description))
            case is NKDiscreteRangedModel<UInt16>:
                models.append(NKDiscreteRangedModel(from: value as! NKDiscreteRangedModel<UInt16>, title: titles[i], description: description, icon: icon))
            case is NKDiscreteRangedModel<UInt32>:
